              ...
              <tbody>
                <tr>
                  <td>
                   ...
                   <!-- Heading --> 
                    <h1 style="font-size:32px;line-height:1.3;font-weight:700;text-align:left;letter-spacing:-1px">Vielen Dank ${order.shipping_address.first_name}!</h1>
            ...
            <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="padding-left:40px;padding-right:40px;padding-top:22px;padding-bottom:22px">
              <tbody>
                <tr>
                  <td>
                    <!-- Versandadresse -->
                    <p style="font-size:15px;line-height:2;margin:0;font-weight:bold">Versand an: ${order.shipping_address.first_name} ${order.shipping_address.last_name}</p>
                    <p style="font-size:14px;line-height:2;margin:0;color:#747474;font-weight:500">${order.shipping_address.address_1}, ${order.shipping_address.postal_code} ${order.shipping_address.city}</p>
                  </td>
                </tr>
              </tbody>
            </table>
